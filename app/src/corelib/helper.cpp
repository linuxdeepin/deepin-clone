...
bool Helper::setCustomFile(const QString &source, const QString &customFileName)
{
    //get dim file name
...
bool Helper::getCustomFile(const QString &source, const QString &customFileName)
{
